...
from train_pep_struct import train_epoch, evaluate_network, train_epoch_graph_classification, train_epoch_domainadaptation
...
def run_epoch_graph_classification(model, train_loader, val_loader, test_loader, num_features, file_name, batch_size):
	...
	for epoch in range(1, args.ft_epoches):
		...
		if time.time() - t0 > 48 * 3600:
			...
			break
	_, test_acc = evaluate_network(args, best_model, optimizer, device, test_loader, f_epoch,
...
def main():
	...
	if args.dataset in ["Peptides-struct"]:
...
if __name__ == '__main__':
	...
	#
	parser.add_argument("--dataset", default="Peptides-struct", help="Dataset")
