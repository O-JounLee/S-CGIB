...
def run(i, dataset_full, num_features, num_classes ):
	...
	print(final_msg)
	return 0
from train_molsolv import train_epoch, evaluate_network, train_epoch_graph_classification,train_epoch_domainadaptation
...
def main():
	...
	graph_lists = []
	graph_labels = []
	if args.dataset in [ "FreeSolv", "ESOL", "Lipo"]:
...
if __name__ == '__main__':
	...
	#FreeSolv  ESOL
	parser.add_argument("--dataset", default="FreeSolv", help="Dataset")
