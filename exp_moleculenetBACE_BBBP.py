...
def run_domain_adaptation(  file_name, pre_train_loader, optimizer, batch_size, device):
	...
	best_loss = 100000000
	best_epoch = 0
	adapt_epoches = args.adapt_epoches
	for epoch in range(1, adapt_epoches ):
...
def run(i, dataset_full, num_features, num_classes ):
	...
	print(final_msg)
	return 0
from train_moleculenetBACE import train_epoch, evaluate_network, train_epoch_graph_classification, train_epoch_domainadaptation
...
if __name__ == '__main__':
	...
	#BACE		BBBP	 
	parser.add_argument("--dataset", default="BBBP", help="Dataset")
